...
public final class FlickrHelper {
    private static final Logger logger = Logger.getLogger(FlickrHelper.class
            .getName());
    private static final String KEY = "6f389781f4a113215c494457edee69c2";
    ...
    public static FlickrHelper newHelper(String keywords) {
        try {
            ...
            try {
                ...
                reader = XMLInputFactory.newInstance().createXMLStreamReader(new URL(buildSearchUrl(keywords)).openStream());
    ...
    private static String buildSearchUrl(String keywords)
        ...
        builder.append("https://api.flickr.com/services/rest")
